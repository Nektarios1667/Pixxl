...
public static class Screen
{
    ...
    public static readonly Point PixelSizePoint = new(PixelSize, PixelSize);
...
{
    public static readonly Vector2 ButtonDim = new(100, 30);
    public static readonly Vector2 ToolDim = new(100, 30);
