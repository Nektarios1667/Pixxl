...
namespace Pixxl.Registry
{
    ...
    {
        public static readonly string[] Names = { "Air", "BlueFire", "Concrete", "Coolant", "Copper", "Explosive", "Faucet", "Fire", "Glass", "Helium", "Ice", "Insulation", "Lava", "Plasma", "Sand", "Steam", "Water" };
