...
namespace Pixxl.Registry
{
    public static class Tools
    {
        ...
        public static readonly Delegate[] Functions = { Reset.All, Reset.Temperature, State.Save, State.Load, Canvas.ChangeViewMode, Window.EraseMode, Window.TogglePlay, Window.RunFrame, Window.CycleSpeed};
