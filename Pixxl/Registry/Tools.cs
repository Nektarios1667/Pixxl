...
namespace Pixxl.Registry
{
    ...
    {
        public static readonly string[] Names = { "Reset", "Reset Temp", "Save", "Load", "Mode", "Erase", "Pause", "Run Frame", "Speed Up"};
        ...
        public static readonly Delegate[] Functions = { Reset.All, Reset.Temperature, State.Save, State.Load, Canvas.Mode, Window.EraseMode, Window.TogglePlay, Window.RunFrame, Window.SpeedUp};
